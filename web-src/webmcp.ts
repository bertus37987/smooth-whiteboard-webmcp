...
const operationSchema = {
  ...
  properties: {
    ...
    d: { type: "string", description: "create_path: SVG path data (M L H V C S Q T A Z, absolute or relative). Drawn into the x/y/width/height box, aspect ratio kept. This is the way to draw something that is not a rectangle." },
