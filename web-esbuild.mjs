...
await Promise.all([cp("web/index.html", "web-dist/index.html"), cp("web/bridge.html", "web-dist/bridge.html"), cp("web/app.css", "web-dist/app.css"), cp("web/fonts", "web-dist/fonts", { recursive: true })]);
